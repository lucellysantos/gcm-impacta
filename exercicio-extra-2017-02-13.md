...
Apache Lounge changes:
  ...
  *) Upgraded OpenSSL to 1.0.2g from 1.0.2f (Changelog)
...
Apache Lounge changes:
  ...
  *) Expat upgraded from 1.95.7 to 2.1.0 (Changelog)
     Solves a few security vulnerabilities
...
ASF changes:
  ...
  *) configure: Fix out of tree build using apr and apr-util in srclib.
     [Rainer Jung]
6-March-2012 Changes with Apache 2.4.1
  *) Build with VC10
...
15-Febuary-2012 Changes with Apache 2.4.1
...
17-January-2012 Changes with Apache 2.4.0
  ...
  *) mod_log_config: Fix segfault when trying t< o log a nameless, valueless
